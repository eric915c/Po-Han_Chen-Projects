...
import java.awt.*;
//This class represents all objects except walls and steel walls.
public class client_normalObject implements client_Actor {
	public String Type;
	public Image image;
	public int xPos;
	public int yPos;
	...
	public client_normalObject(int xPos, int yPos, ClientModel gameModel, String Type, int imageIndex){
		this.xPos = xPos;
		this.yPos = yPos;
