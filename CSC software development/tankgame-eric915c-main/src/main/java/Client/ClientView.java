package Client; // Tank Battle Online Client Edition

import javax.swing.*;
import java.awt.*;

// This class represents the graphical interface for the client
public class ClientView extends JFrame {
	public client_drawingPanel mainPanel;
	...
	public ClientView() {
		...
		// Set up the main animation drawing panel
		mainPanel = new client_drawingPanel();
		...
		// Set up options buttons and IP text field
		enterIP = new JLabel("Enter Host IP");
