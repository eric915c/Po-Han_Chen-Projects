...
public class client_Steelwall implements client_Actor {
	public final String Type = "client_Steelwall";
	...
	public client_Steelwall(int xPos, int  yPos, int orientation, ClientModel gameModel){
		this.xPos = xPos;
		this.yPos = yPos;
