...
public class client_wall implements client_Actor {
	public final String Type = "client_wall";
	public Image wall;
	public int xPos;
	public int yPos;
	...
	public client_wall(int xPos, int  yPos, int orientation, ClientModel gameModel){
		this.xPos = xPos;
		this.yPos = yPos;
