...
// Server-side class
// Since there is only one level object, this class uses static variables.
public class level{
	...
	// Variables needed to create the victory scene
	...
	public static void loadLevel(ServerModel gameModel){
		...
		// Each time a new level is loaded, the difficulty will increase
		...
		// Each level starts with shared properties
		enemyLeft = 20;

		// Load the base, which remains the same for every level
