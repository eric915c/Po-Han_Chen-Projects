...
public class bullet implements Actor{
	...
	public void move(){
		...
		//Check if this bullet hits the map boundary
		...
		//Check if this bullet hits other objects
		...
		//If the bullet hits another object, delete the bullet object from the game system
		if(hitTarget){
			gameModel.removeActor(this);
			notifiyOwner();
			makeBomb();
